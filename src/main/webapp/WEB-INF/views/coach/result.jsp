...
<section id="posts-landing">
	<div id="report" class="portlet box blue">
		...
		<div class="portlet-body">
			<div class="row">
				<div class="col-md-4">
					<table class="table table-sm table-hover table-responsive table-profile">
						<thead>
							<tr>
								<th>Profile</th>
								<th></th>
						...
						<tbody>
							...
							<tr>
								<td>Full Name</td>
								<td>${studentAssignment.studentId.firstName}
									${studentAssignment.studentId.lastName}</td>
							</tr>
				...
				<div class="col-md-4">
					<table class="table table-sm table-hover table-responsive table-category">
						<thead>
							<tr>
								<th>Category</th>
								<th>SubCategory</th>
				...
				<div class="col-md-4">
					...
					<table class="table table-sm table-responsive score-result">
						<thead>
							<tr>
								<th>Score</th>
							</tr>
